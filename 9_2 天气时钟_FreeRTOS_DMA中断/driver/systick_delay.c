...
// 函数变量：中断函数定期执行
static systick_periodic_callback_t systick_periodic_callback;
...
{
    systick_periodic_callback = callback;
}
...
void SysTick_Handler(void)
{
	...
	if(systick_periodic_callback != NULL)
		systick_periodic_callback();
}
